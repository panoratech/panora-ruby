...
module OpenApiSDK
  extend T::Sig
  class MarketingautomationEvents
    extend T::Sig
    ...
    def list(x_connection_token, remote_data = nil, limit = nil, cursor = nil)
      ...
      url = "#{base_url}/marketingautomation/events"
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ListMarketingAutomationEventsRequest, request)
      ...
      res = ::OpenApiSDK::Operations::ListMarketingAutomationEventsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ListMarketingAutomationEventsResponseBody)
          res.object = out
        end
      end
      res
    ...
    def retrieve(x_connection_token, id, remote_data = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::RetrieveMarketingautomationEventRequest,
        base_url,
        '/marketingautomation/events/{id}',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RetrieveMarketingautomationEventRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RetrieveMarketingautomationEventResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::UnifiedMarketingautomationEventOutput)
          res.unified_marketingautomation_event_output = out
        end
      end
      res
    end

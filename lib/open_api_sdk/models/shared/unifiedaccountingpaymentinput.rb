...
module OpenApiSDK
  module Shared
    ...
    class UnifiedAccountingPaymentInput < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :field_mappings, T.nilable(::OpenApiSDK::Shared::UnifiedAccountingPaymentInputFieldMappings), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('field_mappings') } }
      ...
      sig { params(account_id: T.nilable(::String), accounting_period_id: T.nilable(::String), company_info_id: T.nilable(::String), contact_id: T.nilable(::String), currency: T.nilable(::String), exchange_rate: T.nilable(::String), field_mappings: T.nilable(::OpenApiSDK::Shared::UnifiedAccountingPaymentInputFieldMappings), invoice_id: T.nilable(::String), line_items: T.nilable(T::Array[::OpenApiSDK::Shared::LineItem]), total_amount: T.nilable(::Float), tracking_categories: T.nilable(T::Array[::String]), transaction_date: T.nilable(::DateTime), type: T.nilable(::String)).void }
      def initialize(account_id: nil, accounting_period_id: nil, company_info_id: nil, contact_id: nil, currency: nil, exchange_rate: nil, field_mappings: nil, invoice_id: nil, line_items: nil, total_amount: nil, tracking_categories: nil, transaction_date: nil, type: nil)

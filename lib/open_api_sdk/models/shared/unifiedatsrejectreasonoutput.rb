...
module OpenApiSDK
  module Shared
    ...
    class UnifiedAtsRejectreasonOutput < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(created_at: T.nilable(::DateTime), field_mappings: T.nilable(T::Hash[Symbol, ::Object]), id: T.nilable(::String), modified_at: T.nilable(::DateTime), name: T.nilable(::String), remote_data: T.nilable(T::Hash[Symbol, ::Object]), remote_id: T.nilable(::String)).void }
      def initialize(created_at: nil, field_mappings: nil, id: nil, modified_at: nil, name: nil, remote_data: nil, remote_id: nil)

...
module OpenApiSDK
  module Shared
    ...
    class Comment < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(body: ::String, attachments: T.nilable(T::Array[::String]), contact_id: T.nilable(::String), creator_type: T.nilable(::OpenApiSDK::Shared::UnifiedTicketingTicketOutputCreatorType), html_body: T.nilable(::String), is_private: T.nilable(T::Boolean), ticket_id: T.nilable(::String), user_id: T.nilable(::String)).void }

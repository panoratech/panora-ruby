...
module OpenApiSDK
  module Shared
    ...
    class Comment < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :creator_type, T.nilable(::OpenApiSDK::Shared::UnifiedTicketingTicketOutputCreatorType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('creator_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::UnifiedTicketingTicketOutputCreatorType, true) } }
      ...
      sig { params(body: ::String, attachments: T.nilable(T::Array[::Object]), contact_id: T.nilable(::String), creator_type: T.nilable(::OpenApiSDK::Shared::UnifiedTicketingTicketOutputCreatorType), html_body: T.nilable(::String), is_private: T.nilable(T::Boolean), ticket_id: T.nilable(::String), user_id: T.nilable(::String)).void }

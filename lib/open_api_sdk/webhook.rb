...
module OpenApiSDK
  ...
  class Webhook
    ...
    sig { params(request: ::OpenApiSDK::Shared::WebhookDto).returns(::OpenApiSDK::Operations::CreateWebhookResponse) }
    def create(request)
      ...
      res = ::OpenApiSDK::Operations::CreateWebhookResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 201
        if Utils.match_content_type(content_type, 'application/json')

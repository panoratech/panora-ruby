...
module OpenApiSDK
  ...
  class FilestorageDrives
    ...
    def list(x_connection_token, remote_data = nil, limit = nil, cursor = nil)
      ...
      url = "#{base_url}/filestorage/drives"
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ListFilestorageDrivesRequest, request)
      ...
      res = ::OpenApiSDK::Operations::ListFilestorageDrivesResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ListFilestorageDrivesResponseBody)
          res.object = out
        end
      end
      res
    ...
    def retrieve(x_connection_token, id, remote_data = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::RetrieveFilestorageDriveRequest,
        base_url,
        '/filestorage/drives/{id}',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RetrieveFilestorageDriveRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RetrieveFilestorageDriveResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::UnifiedFilestorageDriveOutput)
          res.unified_filestorage_drive_output = out
        end
      end
      res
    end

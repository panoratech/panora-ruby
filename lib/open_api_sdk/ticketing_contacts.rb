...
module OpenApiSDK
  ...
  class TicketingContacts
    ...
    def list(x_connection_token, remote_data = nil, limit = nil, cursor = nil)
      ...
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ListTicketingContactsRequest, request)
      ...
      res = ::OpenApiSDK::Operations::ListTicketingContactsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ListTicketingContactsResponseBody)
          res.object = out
        end
      end
      res
    ...
    def retrieve(x_connection_token, id, remote_data = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::RetrieveTicketingContactRequest,
        base_url,
        '/ticketing/contacts/{id}',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RetrieveTicketingContactRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RetrieveTicketingContactResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RetrieveTicketingContactResponseBody)
          res.object = out
        end
      end
      res

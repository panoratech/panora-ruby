...
module OpenApiSDK
  ...
  class EcommerceFulfillments
    ...
    def list(x_connection_token, remote_data = nil, limit = nil, cursor = nil)
      ...
      url = "#{base_url}/ecommerce/fulfillments"
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ListEcommerceFulfillmentsRequest, request)
      ...
      res = ::OpenApiSDK::Operations::ListEcommerceFulfillmentsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ListEcommerceFulfillmentsResponseBody)
          res.object = out
        end
      end
      res
    ...
    def retrieve(x_connection_token, id, remote_data = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::RetrieveEcommerceFulfillmentRequest,
        base_url,
        '/ecommerce/fulfillments/{id}',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RetrieveEcommerceFulfillmentRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RetrieveEcommerceFulfillmentResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::UnifiedEcommerceFulfillmentOutput)
          res.unified_ecommerce_fulfillment_output = out
        end
      end
      res
    end

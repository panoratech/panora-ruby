...
module OpenApiSDK
  ...
  class HrisDependents
    ...
    def list(x_connection_token, remote_data = nil, limit = nil, cursor = nil)
      ...
      url = "#{base_url}/hris/dependents"
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ListHrisDependentsRequest, request)
      ...
      res = ::OpenApiSDK::Operations::ListHrisDependentsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ListHrisDependentsResponseBody)
          res.object = out
        end
      end
      res
    ...
    def retrieve(x_connection_token, id, remote_data = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::RetrieveHrisDependentRequest,
        base_url,
        '/hris/dependents/{id}',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RetrieveHrisDependentRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RetrieveHrisDependentResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::UnifiedHrisDependentOutput)
          res.unified_hris_dependent_output = out
        end
      end
      res
    end

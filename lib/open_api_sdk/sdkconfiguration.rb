...
module OpenApiSDK
  ...
  SERVERS = [
    'https://api.panora.dev', # 1 - Production server
    'https://api-sandbox.panora.dev', # 1 - Sandbox server
    'https://api-dev.panora.dev', # 1 - Development server
  ].freeze
  ...
  class SDKConfiguration < ::OpenApiSDK::Utils::FieldAugmented
    ...
    def initialize(client, security, server_url, server_idx)
      ...
      @sdk_version = '0.2.3'
      @gen_version = '2.387.0'
      @user_agent = 'speakeasy-sdk/ruby 0.2.3 2.387.0 1.0 panora'
    end
